...
public class RequestsDaoImipl implements RequestsDao {
	...
	private String pendingTableToHtmlString(ArrayList<AppRequest> aar) {
		...
		sb.append("<thead>\r\n"
				+ "        <th>ReqID</th><th>UsrID</th><th>Event</th><th>Location</th><th>Date</th><th>Description</th><th>EventType/Category</th><th>Grading Scale</th><th>Passing Grade</th><th>Justification</th><th>Cost</th><th>Reimb.</th><th>Status</th><th>Approve/Deny</th><th>File</th>"
				+ "    </thead>");
